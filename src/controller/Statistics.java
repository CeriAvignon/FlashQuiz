...
public abstract class Statistics {
	 ...
	 *         answers
	 */
	private static double[] getPercentageChoices(Question question,
	 ...
	 */
	private static double calculatePercentageOfCorrectAnswers(Question question,
			VoterAnswerList voterAnswers) {
	...
	public static double calculateVoterPercentageOfCorrectAnswers(
		...
		for (QuestionList questions : questionLists) {
			for (Map.Entry<Integer, Question> entry : questions.entrySet()) {
				VoterAnswer voterAnswer = voterAnswers.getAnswer(entry.getKey());
	...
	/*
	 * DDD IIIII D DD I D D I D DD I DDD IIIII
	 */
