...
public class stat_user {
	 ...
	 * @param Stat_true
	 *            Double array that contain all of the User's true stat for each session
	 *			  like: Stat_true[20,70,90] for 20%, 70% and 90% true answers in 3 sessions
	 * @return Double array that contain statistics values for good and bad
	 *         answers, like: Res[0] = 45 and Res[1] = 55; so 45% true and 55%
	 *         false
	 */
	// Fonction pour calculer le pourcentage de réussite de l'utilisateur sur une certain nombre de session
	public static double[] stat_resultUserGeneral(int session_number, double[] Stat_true) {
	 ...
	 *
	 * @param res_true
	 *            Int array that contain the number of good answer for the
	 *            User in the session
	 * @param res_false
	 *            Int array that contain the number of bad answer for the
	 *            User in the session
	 * @return Double array that contain statistics values for good and bad
	 *         answers, like: Res[0] = 45 and Res[1] = 55; so 45% true and 55%
	 *         false
	 */
	// Fonction pour calculer le pourcentage de réussite de l'utilisateur sur une session
	...
	//
	// stat_resultUser demande le nombre de bonne réponses et de mauvaises sur une session
	// afin de calculer les pourcentages de bonnes réponses et de mauvaises sur ce même sondage.
	//
	// stat_resultUserGeneral demande le nombre de sondage auquel a répondu l'utilisateur et
