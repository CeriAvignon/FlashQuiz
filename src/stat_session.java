...
public class stat_session
{
	 ...
	 *
	 * @param prop
	 *            String array that contain all the propositions for the question
	 * @param res_true
	 *            String array that contain all the right answers for this question, like ['A','A','B',...] 
	 * @param res_false
	 *            String array that contain all the wrong answers for this question, like ['C','D','D',...] 
	 * @return 
	 *		Double array that contain all the statistics values of the question, like A% = Res[0];
	 */

	// Fonction pour choix multiples
	//
	//	Sert à sortir des statistiques plus précise pour une question de type choix multiples, cependant, si cette question se trouve
	//	dans une session de plusieurs questions de différents type alors on préférera la deuxième fonction qui sort le pourcentage de 
	//	réponses vraies et fausses pour avoir des stats sur la véracité ou non des réponses. Bonne réponse à la session = X% et mauvaise 
...
*/
	...
	/**
	 * Function who calculate statistic of the session (all type of question together)
	 *
	 * @param res_true
	 *            Int array that contain the number of good answer for this session
	 * @param res_false
	 *            Int array that contain the number of bad answer for this session
	 * @return 
	 *		Double array that contain statistics values for good and bad answers, like: Res[0] = 45 and Res[1] = 55; so 45% true 
	 *		and 55% false
	 */
